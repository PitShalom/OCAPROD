...
class Aplicacao:
    def __init__(self, root):
        ...
        self.progress_label.grid(row=1, column=1, pady=20)

        ttk.Button(frame, text="Preencher e Salvar NRs", command=self.preencher_e_salvar_nr, style="TButton").grid(row=2, column=1, pady=20)
    ...
    def preencher_e_salvar_nr(self):
        ...
        required_columns = ['NOME', 'CPF', 'FUNÇÃO', 'DATA_NR18', 'DATA_NR35','DATA_NR01','DATA_NR06',
                            ...
                            'HABILITAÇÃO_SUPERINTENDENTE','HABILITAÇÃO_SUPERINTENDENTE','Nº_REGISTRO_SUPERINTENDENTE']
        ...
        for index, linha in planilha.iterrows():
            ...
            dataNR18_pemt = linha['DATA_NR18_pemt']
            ...
            output_path_nr20_infla = os.path.join(colaborador_folder, f'{nome_colaborador}_{data_atual}_NR20_infla.pdf')
            output_path_nr20_brigada = os.path.join(colaborador_folder, f'{nome_colaborador}_{data_atual}_NR20_brigada.pdf')
            ...
            preencher_nr01(nome, cpf, funcao, dataNR01, nomeTecRep,Hab_SupInt, n_superInt, os.path.join(self.diretorio_modelos_pdf, self.modelo_nr01), output_path_nr01, incluir_funcao=False)
            preencher_nr05(nome, cpf, funcao, dataNR05, nomeTecRep,Hab_SupInt, n_superInt, os.path.join(self.diretorio_modelos_pdf, self.modelo_nr05), output_path_nr05, incluir_funcao=False)
            preencher_nr06(nome, cpf, funcao, dataNR06, nomeTecRep,Hab_SupInt, n_superInt, os.path.join(self.diretorio_modelos_pdf, self.modelo_nr06), output_path_nr06, incluir_funcao=False)
            ...
            preencher_nr11(nome, cpf, funcao, dataNR11, nomeTecRep,Hab_SupInt, n_superInt, os.path.join(self.diretorio_modelos_pdf, self.modelo_11), output_path_nr11, incluir_funcao=False)
            preencher_nr12(nome, cpf, funcao, dataNR12, nomeTecRep,Hab_SupInt, n_superInt, os.path.join(self.diretorio_modelos_pdf, self.modelo_12), output_path_nr12, incluir_funcao=False)
            preencher_nr17(nome, cpf, funcao, dataNR17, nomeTecRep,Hab_SupInt, n_superInt, os.path.join(self.diretorio_modelos_pdf, self.modelo_17), output_path_nr17, incluir_funcao=False)
            preencher_nr18(nome, cpf, funcao, dataNR18, nomeTecRep,Hab_SupInt, n_superInt, os.path.join(self.diretorio_modelos_pdf, self.modelo_nr18), output_path_nr18, incluir_funcao=False)
            preencher_nr18_pemt(nome, cpf, funcao, dataNR18_pemt, nomeTecRep,Hab_SupInt, n_superInt, os.path.join(self.diretorio_modelos_pdf, self.modelo_nr18_pemt), output_path_nr18_pemt, incluir_funcao=False)
            preencher_nr20_brigada(nome, cpf, funcao, dataNR20_brigada, nomeTecRep,Hab_SupInt, n_superInt, os.path.join(self.diretorio_modelos_pdf, self.modelo_nr20_brigada), output_path_nr20_brigada, incluir_funcao=False)
            preencher_nr20_infla(nome, cpf, funcao, dataNR20_inflamaveis, nomeTecRep,Hab_SupInt, n_superInt, os.path.join(self.diretorio_modelos_pdf, self.modelo_nr20_infla), output_path_nr20_infla, incluir_funcao=False)
            preencher_nr33(nome, cpf, funcao, dataNR33, nomeTecRep,Hab_SupInt, n_superInt, os.path.join(self.diretorio_modelos_pdf, self.modelo_nr33), output_path_nr33, incluir_funcao=False)
            preencher_nr34(nome, cpf, funcao, dataNR34, nomeTecRep,Hab_SupInt, n_superInt, os.path.join(self.diretorio_modelos_pdf, self.modelo_nr34), output_path_nr34, incluir_funcao=False)
            preencher_nr34_adm(nome, cpf, funcao, dataNR34_adm, nomeTecRep,Hab_SupInt, n_superInt, os.path.join(self.diretorio_modelos_pdf, self.modelo_nr34_adm), output_path_nr34_adm, incluir_funcao=False)
            preencher_nr34_obs_quente(nome, cpf, funcao, dataNR34_obs_quente, nomeTecRep,Hab_SupInt, n_superInt, os.path.join(self.diretorio_modelos_pdf, self.modelo_nr34_obs_quente), output_path_nr34_obs_quente, incluir_funcao=False)
            preencher_nr35(nome, cpf, funcao, dataNR35,Hab_SupInt, nomeTecRep, n_superInt, os.path.join(self.diretorio_modelos_pdf, self.modelo_nr35), output_path_nr35, incluir_funcao=False)
            preencher_OS_adm_geral(nome, cpf, funcao, nomeTecRep, cpf_superInt, os.path.join(self.diretorio_modelos_pdf, self.modelo_OS_adm_geral), output_path_OS_adm_geral, incluir_funcao=True)
            preencher_OS_adm_obra(nome, cpf, funcao, nomeTecRep, cpf_superInt, os.path.join(self.diretorio_modelos_pdf, self.modelo_OS_adm_de_obra), output_path_OS_adm_obra, incluir_funcao=True)
            preencher_OS_aumoxarifado(nome, cpf, funcao, nomeTecRep, cpf_superInt, os.path.join(self.diretorio_modelos_pdf, self.modelo_OS_aumoxarifado), output_path_OS_aumoxarifado, incluir_funcao=True)
            preencher_OS_obras_civil(nome, cpf, funcao, nomeTecRep, cpf_superInt, os.path.join(self.diretorio_modelos_pdf, self.modelo_OS_obra_civil), output_path_OS_obras_civil, incluir_funcao=True)
            preencher_OS_obras_eletricas(nome, cpf, funcao, nomeTecRep, cpf_superInt, os.path.join(self.diretorio_modelos_pdf, self.modelo_OS_obra_eletrica), output_path_OS_obra_eletrica, incluir_funcao=True)
            preencher_OS_obras_hidraulicas(nome, cpf, funcao, nomeTecRep, cpf_superInt, os.path.join(self.diretorio_modelos_pdf, self.modelo_OS_obra_hidraulica), output_path_OS_obra_hidraulica, incluir_funcao=True)
            preencher_OS_soldador(nome, cpf, funcao, nomeTecRep, cpf_superInt, os.path.join(self.diretorio_modelos_pdf, self.modelo_OS_soldador), output_path_OS_soldador, incluir_funcao=True)
            ...
            preencher_fichaEPI(nome,funcao, n_registroTST, os.path.join(self.diretorio_modelos_pdf, self.modelo_fichaEPI), output_path_fichaEPI, incluir_funcao=True)
            preencher_cracha(nome,nome_obra,funcao,data_aso,dataNR06,dataNR12,dataNR18,dataNR35,dataNR01,dataNR10_basica,dataNR10_complementar,dataNR11,dataNR18_pemt,dataNR20_inflamaveis,dataNR20_brigada,dataNR33,dataNR34,dataNR34_adm,dataNR34_obs_quente,dataNR17, os.path.join(self.diretorio_modelos_pdf, self.modelo_cracha), output_path_cracha, incluir_funcao=True)
            # Adicione esta linha para fazer upload da pasta inteira do colaborador para o Google Drive
           # upload_folder_to_google_drive(colaborador_folder, nome_colaborador)
